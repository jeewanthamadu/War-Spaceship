...
$(function () {
    ...
    function repeat() {
        if (collision(spaceship, stone_1) || collision(spaceship, stone_2) || collision(spaceship, stone_3)) {
            stop_the_game();
            return;
        }
        ...
        spaceship_down(stone_1);
        spaceship_down(stone_2);
        spaceship_down(stone_3);
